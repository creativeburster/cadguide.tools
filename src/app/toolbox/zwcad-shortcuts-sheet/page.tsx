        ...
        <section className="bg-red-50 border-y border-red-100 py-6 print:hidden">
          <div className="max-w-[900px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-4">
            ...
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-lg font-black text-red-900 uppercase tracking-wider">Migrating from AutoCAD?</h2>
              <p className="text-lg text-red-700/80 font-medium mt-1">
                ZWCAD reads <code className="bg-red-100 px-1.5 py-0.5 rounded text-base">acad.pgp</code> files directly.
