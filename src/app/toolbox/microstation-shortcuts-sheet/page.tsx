...
import BentleyMicroStationClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Bentley MicroStation V8i Keyboard Shortcuts Guide | CADGuide.tools',
  description: 'Quick reference reference table for Bentley MicroStation key-ins and keyboard shortcuts. Speed up civil design.',
  path: '/toolbox/microstation-shortcuts-sheet',
});

export default function BentleyMicroStationPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Bentley MicroStation Shortcuts', path: '/toolbox/microstation-shortcuts-sheet' },
  ]);
