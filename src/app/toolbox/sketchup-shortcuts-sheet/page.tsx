...
import SketchUpProClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'SketchUp Pro Quick Reference Hotkeys Cheat Sheet | CADGuide.tools',
  description: 'Quick reference guide for SketchUp Pro keyboard shortcuts, drawing tools, and view controls. Print optimizing for A4 layout.',
  path: '/toolbox/sketchup-shortcuts-sheet',
});

export default function SketchUpProPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'SketchUp Pro Shortcuts', path: '/toolbox/sketchup-shortcuts-sheet' },
  ]);
