        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          ...
          <div className="flex items-center bg-slate-100 rounded-2xl p-1 border border-slate-200/50">
            <button
              ...
              className={`px-4 py-2 h-10 rounded-xl text-xs font-black flex items-center gap-1.5 transition-all ${
                viewMode === 'card'
          ...
          <button
            onClick={handlePrint}
            className="h-12 px-6 rounded-2xl border border-slate-200 hover:border-slate-300 text-slate-700 text-xs font-black flex items-center justify-center gap-2 hover:bg-slate-50 transition-all bg-white"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {filteredShortcuts.length > 0 ? (
            filteredShortcuts.map((item) => (
              ...
              >
                ...
                <div>
                  <div className="flex items-start justify-between mb-4">
                    <button
                      ...
                      className="group/btn flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-white font-mono font-black text-sm tracking-tight shadow-md hover:bg-blue-600 hover:border-blue-500 transition duration-200"
                    ...
                    <span className="text-xs font-black text-slate-400 font-mono tracking-tight select-all">
                      {item.command}
                    </span>
                  </div>
                ...
                <div className="border-t border-slate-50 pt-4 mt-2 grid grid-cols-2 gap-2 text-xs font-semibold text-slate-500 font-mono">
