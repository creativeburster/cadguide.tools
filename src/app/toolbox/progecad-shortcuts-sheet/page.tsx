        ...
        <section className="bg-gradient-to-r from-slate-900 to-purple-950 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-[1fr_320px] gap-8 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-base font-black bg-purple-500/10 text-purple-400 border border-purple-500/20 mb-5 uppercase tracking-[0.15em]">
                ...
                <p className="text-xl text-slate-300 leading-relaxed font-medium">
                  ...
                  <code className="text-purple-300 bg-purple-500/10 px-1.5 py-0.5 rounded text-lg mx-1">.pgp</code> and
                  <code className="text-purple-300 bg-purple-500/10 px-1.5 py-0.5 rounded text-lg mx-1">.ick</code> files directly.
                </p>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-3xl p-5">
                <h2 className="text-base font-black text-purple-400 uppercase tracking-wider mb-3">progeCAD Extras</h2>
                <ul className="space-y-2 text-lg text-slate-300 font-medium">
