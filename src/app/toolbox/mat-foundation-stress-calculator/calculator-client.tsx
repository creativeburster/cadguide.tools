    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"contact_pressure = total_load/area. Rigidity K = E_c*I_mat/(E_s*B^4). K>0.5 rigid, else flexible. Settlement limit L/500 to L/1000. Thickness from one-way and punching shear."}
        </p>
