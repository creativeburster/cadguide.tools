...
import HydrostaticPressureCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Hydrostatic Pressure Calculator",
  description: "Calculate hydrostatic pressure at depth in fluids.",
  path: '/toolbox/hydrostatic-pressure-calculator',
});
...
export default function HydrostaticPressureCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    ...
    { name: "Hydrostatic Pressure Calculator", path: '/toolbox/hydrostatic-pressure-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Hydrostatic Pressure <span className="text-teal-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate hydrostatic pressure at depth in fluids.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <HydrostaticPressureCalculatorClient />
        </section>
      </main>
    </>
  );
