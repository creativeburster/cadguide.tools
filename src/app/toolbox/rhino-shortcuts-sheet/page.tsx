...
import Rhino3DClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Rhino 3D Shortcut Keys & Command Aliases Guide | CADGuide.tools',
  description: 'Search all Rhino 3D hotkeys, mouse modifiers, and custom command aliases. Download custom Rhino .txt shortcuts to optimize your industrial design workflow.',
  path: '/toolbox/rhino-shortcuts-sheet',
});
...
export default function Rhino3DPage() {
  const breadcrumbs = siteBreadcrumbLd([
    ...
    { name: 'Rhino 3D Shortcuts', path: '/toolbox/rhino-shortcuts-sheet' },
  ]);
