    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-yellow-950/40 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-base font-black bg-yellow-500/10 text-yellow-400 border border-yellow-500/20 mb-5 uppercase tracking-[0.15em]">
              ...
              <p className="text-xl md:text-lg text-slate-300 leading-relaxed max-w-2xl font-medium">
                ...
                <kbd className="bg-yellow-500/10 text-yellow-300 px-2 py-0.5 rounded font-mono text-lg mx-1">F5</kbd>
        ...
        <section className="bg-white border-b border-slate-100 py-8 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-4">FEA Workflow Stages</h2>
              ...
              {[
                ...
                <div key={stage.label} className="flex items-center gap-2">
                  <div className="flex items-center gap-2 bg-yellow-50 rounded-xl px-4 py-2 border border-yellow-100">
                    ...
                    <span className="text-lg font-bold text-yellow-900">{stage.label}</span>
                  </div>
