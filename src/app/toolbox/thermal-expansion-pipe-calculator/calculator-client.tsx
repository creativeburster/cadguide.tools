...
export default function ThermalExpansionPipeCalculatorClient() {
  const [inputs, setInputs] = useState(["100","50","steel","200"]);
  ...
  const result = useMemo(() => {
    const L=parseFloat(inputs[0]),dT=parseFloat(inputs[1]),mat=inputs[2],E=parseFloat(inputs[3])*1e9;const a=mat==='steel'?12e-6:mat==='copper'?17e-6:23e-6;const dL=a*L*dT*1000;const sigma=E*a*dT/1e6;const A=Math.PI*0.1*0.1/4;const F=sigma*A*1e6/1000;return{dL,sigma,F};
  }, [inputs]);
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-100 p-8 shadow-sm space-y-6">
          ...
          <button onClick={() => setInputs(["100","50","steel","200"])}
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                <div className="text-base font-black text-blue-400 uppercase tracking-wider mb-2">Expansion</div>
                <div className="text-3xl font-black text-blue-700">{formatNum(result.dL)}<span className="text-lg text-blue-400"> mm</span></div>
              </div>
              <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
                <div className="text-base font-black text-green-400 uppercase tracking-wider mb-2">Thermal Stress</div>
                <div className="text-3xl font-black text-green-700">{formatNum(result.sigma)}<span className="text-lg text-green-400"> MPa</span></div>
              </div>
              <div className="bg-orange-50 rounded-2xl p-6 border border-orange-100">
                <div className="text-base font-black text-orange-400 uppercase tracking-wider mb-2">Force if Fixed</div>
