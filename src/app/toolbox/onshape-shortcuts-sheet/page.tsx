      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-gradient-to-b from-sky-500 via-sky-600 to-slate-900 text-white py-20 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-base font-black bg-white/10 text-sky-200 border border-white/20 mb-6 uppercase tracking-[0.15em]">
              ☁️ Cloud-Native CAD
            </div>
            ...
            <p className="text-xl md:text-lg text-sky-100/80 leading-relaxed max-w-2xl mx-auto font-medium">
              Over 70 browser-based shortcuts for Part Studio, Assembly, Sketch, Drawing, and 3D view.
              Press <kbd className="bg-white/15 px-2 py-0.5 rounded font-mono text-lg">Shift+?</kbd> anywhere in Onshape to see them all in-app.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <div className="text-lg font-bold text-slate-700">Sketch: Line</div>
                <div className="text-base text-slate-400 font-medium mt-0.5">Single-key tools in sketch mode</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-black text-sky-600 mb-1">Shift+E</div>
                <div className="text-lg font-bold text-slate-700">Part Studio: Extrude</div>
                <div className="text-base text-slate-400 font-medium mt-0.5">Shift+letter for features</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-black text-sky-600 mb-1">Shift+7</div>
                <div className="text-lg font-bold text-slate-700">View: Isometric</div>
                <div className="text-base text-slate-400 font-medium mt-0.5">Shift+number for views</div>
              </div>
            </div>
          </div>
        </section>
