    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Efficiency = P_out/(P_out + P_losses). Losses: stator Cu, rotor Cu, iron, friction, windage, stray load. IE1/IE2/IE3/IE4 thresholds by kW. Includes load factor, power factor, and slip calculation."}
        </p>
