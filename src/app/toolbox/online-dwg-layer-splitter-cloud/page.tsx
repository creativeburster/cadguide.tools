...
import OnlineDwgLayerSplitterCloudClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Best Online DWG Layer Splitters & Batch Separators | CADGuide.tools',
  description: 'Compare online DWG layer splitters. Review batch level isolation, WBLOCK coordinate alignments, and custom layer script builders.',
  path: '/toolbox/online-dwg-layer-splitter-cloud',
});

export default function OnlineDwgLayerSplitterCloudPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Online DWG Layer Splitter & Batch Drawing Separator', path: '/toolbox/online-dwg-layer-splitter-cloud' },
  ]);
    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="py-12 max-w-[1000px] mx-auto px-6 md:px-12 print:p-0">
          <OnlineDwgLayerSplitterCloudClient />
        </section>
      </main>
    </>
);
