        ...
        <section className="pb-24 pt-4 max-w-[1200px] mx-auto px-6 md:px-12">
          <div className="border-t border-slate-200/80 pt-12">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
              <div>
                <span className="text-sm font-black uppercase tracking-widest text-blue-600 block mb-1">Expert Reading</span>
                <h2 className="text-2xl font-black text-slate-900 tracking-tight">Drafting Standards & Printing Guides</h2>
                <p className="text-base text-slate-500 font-medium mt-1">Further reading on CAD drawing standards, layouts, and high-precision outputs.</p>
              </div>
              <Link href="/guides" className="text-base font-black text-blue-600 hover:underline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <h3 className="text-lg font-bold text-slate-900 leading-snug group-hover:text-blue-600 transition-colors">ISO 128 & AIA CAD Layer Standards →</h3>
                <p className="text-base text-slate-500 mt-2 font-medium">Download default templates for standard naming conventions, custom line types, and pen widths.</p>
              </Link>
              ...
              >
                ...
                <h3 className="text-lg font-bold text-slate-900 leading-snug group-hover:text-blue-600 transition-colors">High-Density Batch Plotting Configurations →</h3>
                <p className="text-base text-slate-500 mt-2 font-medium">Solve scale offsets, blank spaces, and multi-sheet PDF output line style discrepancies.</p>
              </Link>
            </div>
          </div>
        </section>
