...
import CorrosionRateCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Corrosion Rate Calculator",
  description: "Calculate corrosion rate from mass loss and exposure area.",
  path: '/toolbox/corrosion-rate-calculator',
});

export default function CorrosionRateCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Corrosion Rate Calculator", path: '/toolbox/corrosion-rate-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Corrosion Rate <span className="text-orange-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate corrosion rate from mass loss and exposure area.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <CorrosionRateCalculatorClient />
        </section>
      </main>
    </>
  );
