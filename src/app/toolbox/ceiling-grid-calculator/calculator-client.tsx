    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Main runners = room_length/tile_width. Cross tees = (room_length/tile_width)*(room_width/tile_length-1). Standard 2x2ft or 2x4ft. Wall angle = 2*(L+W). Includes waste and border tiles."}
        </p>
