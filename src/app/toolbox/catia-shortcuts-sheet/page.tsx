...
import DassaultCATIAClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Dassault CATIA V5/V6 Key Shortcuts Table | CADGuide.tools',
  description: 'Benchmark and view Dassault CATIA V5/V6 essential shortcut keys for Part Design, Sketcher, and Assembly workbenches.',
  path: '/toolbox/catia-shortcuts-sheet',
});

export default function DassaultCATIAPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Dassault CATIA Shortcuts', path: '/toolbox/catia-shortcuts-sheet' },
  ]);
