    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Sliding FS = (W*mu + Pp)/Ph. Ph = Ka*gamma*H^2/2. Overturning FS = M_resisting/M_overturning. Min FS = 1.5 sliding, 2.0 overturning. Includes surcharge, water pressure, passive resistance."}
        </p>
