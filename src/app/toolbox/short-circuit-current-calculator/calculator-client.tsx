    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"MVA method: SC_MVA = V^2/Z_total. I_sc = SC_MVA/(sqrt(3)*V). Includes utility source, transformer, cable, motor contribution. Compare to symmetrical/asymmetrical and X/R ratio."}
        </p>
