...
export default function RackPinionCalculatorClient() {
  const [inputs, setInputs] = useState(["40","100","10"]);
  ...
  const result = useMemo(() => {
    const d=parseFloat(inputs[0])/1000,n=parseFloat(inputs[1]),T=parseFloat(inputs[2]);const v=Math.PI*d*n/60;const F=2*T/d;const travel=Math.PI*d*1000;return{v,F,travel};
  }, [inputs]);
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-100 p-8 shadow-sm space-y-6">
          ...
          <div key="0">
            <label className="text-base font-black text-slate-400 uppercase tracking-wider block mb-2">Pinion Dia (mm)</label>
          ...
          <button onClick={() => setInputs(["40","100","10"])}
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                <div className="text-base font-black text-blue-400 uppercase tracking-wider mb-2">Linear Speed</div>
              ...
              <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
                <div className="text-base font-black text-green-400 uppercase tracking-wider mb-2">Linear Force</div>
              ...
              <div className="bg-orange-50 rounded-2xl p-6 border border-orange-100">
                <div className="text-base font-black text-orange-400 uppercase tracking-wider mb-2">Travel per Rev</div>
                <div className="text-3xl font-black text-orange-700">{formatNum(result.travel)}<span className="text-lg text-orange-400"> mm</span></div>
              </div>
            </div>
