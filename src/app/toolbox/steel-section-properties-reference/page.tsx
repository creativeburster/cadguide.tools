    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-gradient-to-r from-slate-800 to-slate-950 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-black bg-slate-400/10 text-slate-300 border border-slate-400/20 mb-5 uppercase tracking-[0.15em]">
                Eurocode 3 · EN 10025
              </div>
        ...
        <section className="bg-white border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-sm font-black text-slate-400 uppercase tracking-wider mb-3">Section Families</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              <div className="bg-slate-50 rounded-xl border border-slate-100 p-3">
                <div className="font-black text-slate-800 text-xs uppercase mb-1">IPE</div>
                <div className="text-slate-500 font-medium">European I-beams (parallel flanges)</div>
              </div>
              <div className="bg-slate-50 rounded-xl border border-slate-100 p-3">
                <div className="font-black text-slate-800 text-xs uppercase mb-1">HEA / HEB</div>
                <div className="text-slate-500 font-medium">European H-sections (wide flange)</div>
              </div>
              <div className="bg-slate-50 rounded-xl border border-slate-100 p-3">
                <div className="font-black text-slate-800 text-xs uppercase mb-1">UB / UC</div>
                <div className="text-slate-500 font-medium">British Universal Beams / Columns</div>
              </div>
              <div className="bg-slate-50 rounded-xl border border-slate-100 p-3">
                <div className="font-black text-slate-800 text-xs uppercase mb-1">UPE / PFC</div>
