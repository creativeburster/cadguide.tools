          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
              ...
              <div className="hidden md:block bg-white/5 border border-white/10 rounded-3xl p-6 min-w-[180px]">
                <h2 className="text-xs font-black text-orange-400 uppercase tracking-wider mb-3">Drill Formula</h2>
                <div className="text-sm text-slate-300 font-mono leading-relaxed">
                  Tap Drill =<br />
                  Major Ø − Pitch<br />
                  <span className="text-xs text-slate-400 mt-2 block">e.g. M8×1.25 → 8−1.25 = 6.8mm</span>
                </div>
              </div>
            </div>
          </div>
