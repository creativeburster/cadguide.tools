...
import OnlinePdfToDwgConverterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Best Online Vector PDF to CAD DWG Converter Guide | CADGuide.tools',
  description: 'Compare the best online PDF to DWG converters. Review layer fidelity, text OCR accuracy, and find safe, registry-compliant cloud conversion portals.',
  path: '/toolbox/online-pdf-to-dwg-converter',
});

export default function OnlinePdfToDwgConverterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Online Vector PDF to CAD DWG Converter Portal', path: '/toolbox/online-pdf-to-dwg-converter' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-16 relative overflow-hidden print:hidden">
          ...
          <div className="max-w-[1000px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-black mb-6 tracking-tight leading-tight">
              Online Vector PDF to CAD DWG Converter Portal
            </h1>
