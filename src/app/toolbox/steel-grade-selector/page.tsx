...
import SteelGradeSelectorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Steel Grade Strength Calculator",
  description: "Calculate yield and tensile strength for common steel grades.",
  path: '/toolbox/steel-grade-selector',
});

export default function SteelGradeSelectorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Steel Grade Strength Calculator", path: '/toolbox/steel-grade-selector' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Steel Grade Strength <span className="text-orange-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate yield and tensile strength for common steel grades.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <SteelGradeSelectorClient />
        </section>
      </main>
    </>
  );
