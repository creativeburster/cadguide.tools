    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"ACI 318: Ld = (fy*psi_t*psi_e*psi_s*lambda)/(25*lambda*sqrt(fc))*db. Compression Ldc = max(0.22*fy/sqrt(fc)*db, 8*db, 150mm). Includes epoxy, spacing, cover, excess rebar factors."}
        </p>
