...
export default function InjectionMoldingClampCalculatorClient() {
  const [inputs, setInputs] = useState(["40","100","1.2"]);
  ...
  const result = useMemo(() => {
    const P=parseFloat(inputs[0])*1e6,A=parseFloat(inputs[1])/10000,sf=parseFloat(inputs[2]);const F=P*A*sf/1000;const Ft=F/9.81;return{F,Ft};
  }, [inputs]);
    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-100 p-8 shadow-sm space-y-6">
          ...
          <button onClick={() => setInputs(["40","100","1.2"])}
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-blue-50 rounded-2xl p-6 border border-blue-100">
                <div className="text-base font-black text-blue-400 uppercase tracking-wider mb-2">Clamp Force</div>
              ...
              <div className="bg-green-50 rounded-2xl p-6 border border-green-100">
                <div className="text-base font-black text-green-400 uppercase tracking-wider mb-2">Clamp Force</div>
