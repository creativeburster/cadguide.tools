...
import PTCCreoClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'PTC Creo Parametric Shortcut Keys Reference | CADGuide.tools',
  description: 'Search keyboard shortcut codes and mouse gestures configurations for PTC Creo Parametric. Optimize your 3D modeling workflow.',
  path: '/toolbox/creo-shortcuts-sheet',
});

export default function PTCCreoPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'PTC Creo Shortcuts', path: '/toolbox/creo-shortcuts-sheet' },
  ]);
