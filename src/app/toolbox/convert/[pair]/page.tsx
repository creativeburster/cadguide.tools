...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://cadguide.tools/toolbox/convert/${pair.slug}`,
    },
    openGraph: {
      title: pair.metaTitle,
      description: pair.metaDescription,
      url: `https://cadguide.tools/toolbox/convert/${pair.slug}`,
      type: 'website',
    },
  };
}
    ...
    '@graph': [
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 4, name: pair.title, item: `https://cadguide.tools/toolbox/convert/${pair.slug}` }
        ]
      },
      {
        '@type': 'FAQPage',
