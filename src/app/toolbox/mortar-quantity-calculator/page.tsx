...
import MortarQuantityCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Mortar Quantity Calculator",
  description: "Calculate mortar volume and cement bags for brick and block walls.",
  path: '/toolbox/mortar-quantity-calculator',
});

export default function MortarQuantityCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Mortar Quantity Calculator", path: '/toolbox/mortar-quantity-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Mortar Quantity <span className="text-red-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate mortar volume and cement bags for brick and block walls.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <MortarQuantityCalculatorClient />
        </section>
      </main>
    </>
  );
