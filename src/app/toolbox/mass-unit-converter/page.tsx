...
import MassUnitConverterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Mass Unit Converter",
  description: "Convert between kg, g, mg, ton, lb, oz, slug, and quintal.",
  path: '/toolbox/mass-unit-converter',
});

export default function MassUnitConverterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Mass Unit Converter", path: '/toolbox/mass-unit-converter' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Mass Unit <span className="text-purple-400">Converter</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Convert between kg, g, mg, ton, lb, oz, slug, and quintal.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <MassUnitConverterClient />
        </section>
      </main>
    </>
  );
