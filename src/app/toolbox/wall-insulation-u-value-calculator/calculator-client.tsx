    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"R_total = sum(R_i). Thermal bridge: R_eff = R_cavity*R_stud/(R_cavity*f_stud + R_stud*f_cavity). U = 1/R_total. Wood/steel stud, masonry, ICF. Compares to code prescriptive R-values."}
        </p>
