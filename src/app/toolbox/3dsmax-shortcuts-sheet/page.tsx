    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
              ...
              <div className="hidden md:block bg-white/5 border border-white/10 rounded-3xl p-6 min-w-[200px]">
                <h2 className="text-base font-black text-teal-400 uppercase tracking-wider mb-4">Transform Tools</h2>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={t.k} className="flex items-center gap-3">
                      <kbd className="font-mono bg-slate-800 text-teal-300 px-3 py-1.5 rounded-lg font-black text-lg select-all min-w-[44px] text-center">{t.k}</kbd>
                      <span className="text-lg text-slate-300 font-medium">{t.d}</span>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="bg-white border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-3">Editable Poly Sub-Object Levels</h2>
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={lvl.key} className="flex items-center gap-2 bg-teal-50 rounded-xl px-4 py-2 border border-teal-100">
                  <kbd className="font-mono bg-slate-900 text-teal-300 px-2 py-0.5 rounded font-black text-base select-all">{lvl.key}</kbd>
                  <span className="text-lg font-bold text-teal-800">{lvl.label}</span>
                </div>
              ))}
            </div>
          </div>
