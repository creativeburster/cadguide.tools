...
import CoolingLoadCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Cooling Load Calculator",
  description: "Calculate sensible, latent, and total cooling load for HVAC design.",
  path: '/toolbox/cooling-load-calculator',
});

export default function CoolingLoadCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Cooling Load Calculator", path: '/toolbox/cooling-load-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Cooling Load <span className="text-green-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate sensible, latent, and total cooling load for HVAC design.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <CoolingLoadCalculatorClient />
        </section>
      </main>
    </>
  );
