        ...
        <section className="bg-gradient-to-r from-blue-950 to-slate-900 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-black bg-blue-500/10 text-blue-400 border border-blue-500/20 mb-5 uppercase tracking-[0.15em]">
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-6">
                <h2 className="text-xs font-black text-blue-400 uppercase tracking-wider mb-3">Thread Series</h2>
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    <span className="font-black text-blue-300 bg-blue-500/10 px-2 py-1 rounded-lg text-xs">UNC</span>
                    <span className="text-slate-300 font-medium">Unified National Coarse — general purpose</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="font-black text-blue-300 bg-blue-500/10 px-2 py-1 rounded-lg text-xs">UNF</span>
                    <span className="text-slate-300 font-medium">Unified National Fine — precision & sealing</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="font-black text-blue-300 bg-blue-500/10 px-2 py-1 rounded-lg text-xs">UNEF</span>
