    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-white border-b border-slate-100 py-8 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-4">How Two-Letter Shortcuts Work</h2>
              ...
              {[
                ...
                <div key={item.keys} className="bg-red-50 rounded-2xl border border-red-100 p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <kbd className="font-mono bg-slate-900 text-red-400 px-2.5 py-1 rounded-lg font-black text-base select-all">{item.keys}</kbd>
                  </div>
                  <div className="font-bold text-slate-800 text-lg">{item.cmd}</div>
                  <p className="text-base text-slate-500 font-medium mt-1">{item.desc}</p>
                </div>
              ))}
            </div>
            <p className="text-base text-slate-400 font-medium mt-3 text-center">
