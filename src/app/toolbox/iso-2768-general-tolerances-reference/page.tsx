    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-white border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-3">Accuracy Classes</h2>
            <div className="grid grid-cols-4 gap-3 text-lg">
              <div className="bg-blue-50 rounded-xl border border-blue-100 p-3 text-center">
                ...
                <div className="text-base font-bold text-blue-600 uppercase">Fine</div>
                <div className="text-base text-slate-500 mt-1">Precision instruments</div>
              </div>
              <div className="bg-green-50 rounded-xl border border-green-100 p-3 text-center">
                ...
                <div className="text-base font-bold text-green-600 uppercase">Medium</div>
                <div className="text-base text-slate-500 mt-1">General engineering (default)</div>
              </div>
              <div className="bg-orange-50 rounded-xl border border-orange-100 p-3 text-center">
                ...
                <div className="text-base font-bold text-orange-600 uppercase">Coarse</div>
                <div className="text-base text-slate-500 mt-1">Structural / non-critical</div>
              </div>
              <div className="bg-red-50 rounded-xl border border-red-100 p-3 text-center">
                ...
                <div className="text-base font-bold text-red-600 uppercase">Very Coarse</div>
                <div className="text-base text-slate-500 mt-1">Castings / rough work</div>
              </div>
            </div>
          </div>
        </section>
