...
import RevitBIMClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Revit Keyboard Shortcuts & Command Codes Table | CADGuide.tools',
  description: 'Lookup Revit keyboard shortcut keys and double-character codes for architecture, structure, and MEP workflows. Speed up your BIM modeling.',
  path: '/toolbox/revit-shortcuts-sheet',
});

export default function RevitBIMPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Revit BIM Shortcuts', path: '/toolbox/revit-shortcuts-sheet' },
  ]);
