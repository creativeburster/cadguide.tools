...
import SheetMetalBlankCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Sheet Metal Blank Size Calculator",
  description: "Calculate blank development length for bent sheet metal parts.",
  path: '/toolbox/sheet-metal-blank-calculator',
});

export default function SheetMetalBlankCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Sheet Metal Blank Size Calculator", path: '/toolbox/sheet-metal-blank-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Sheet Metal Blank Size <span className="text-purple-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate blank development length for bent sheet metal parts.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <SheetMetalBlankCalculatorClient />
        </section>
      </main>
    </>
  );
