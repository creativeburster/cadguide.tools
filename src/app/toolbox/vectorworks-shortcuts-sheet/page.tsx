...
import VectorworksProClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Vectorworks Keyboard Shortcuts Reference Chart | CADGuide.tools',
  description: 'Find keyboard shortcuts for Vectorworks Landmark, Spotlight, and Architect design suites. Speed up your vector drafting.',
  path: '/toolbox/vectorworks-shortcuts-sheet',
});

export default function VectorworksProPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Vectorworks Pro Shortcuts', path: '/toolbox/vectorworks-shortcuts-sheet' },
  ]);
