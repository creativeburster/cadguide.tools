...
import TemperatureUnitConverterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Temperature Unit Converter",
  description: "Convert between Celsius, Fahrenheit, Kelvin, and Rankine.",
  path: '/toolbox/temperature-unit-converter',
});

export default function TemperatureUnitConverterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Temperature Unit Converter", path: '/toolbox/temperature-unit-converter' },
  ]);
    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50">
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Temperature Unit <span className="text-purple-400">Converter</span>
            </h1>
        ...
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <TemperatureUnitConverterClient />
        </section>
      </main>
    </>
  );
