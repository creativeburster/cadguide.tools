...
import PressureUnitConverterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Pressure Unit Converter",
  description: "Convert between Pa, kPa, MPa, bar, psi, atm, mmHg, and kg/cm2.",
  path: '/toolbox/pressure-unit-converter',
});

export default function PressureUnitConverterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Pressure Unit Converter", path: '/toolbox/pressure-unit-converter' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Pressure Unit <span className="text-purple-400">Converter</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Convert between Pa, kPa, MPa, bar, psi, atm, mmHg, and kg/cm2.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <PressureUnitConverterClient />
        </section>
      </main>
    </>
  );
