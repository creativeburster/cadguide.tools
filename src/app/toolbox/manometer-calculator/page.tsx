...
import ManometerCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Manometer Pressure Calculator",
  description: "Calculate pressure difference from manometer fluid height.",
  path: '/toolbox/manometer-calculator',
});

export default function ManometerCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Manometer Pressure Calculator", path: '/toolbox/manometer-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate pressure difference from manometer fluid height.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <ManometerCalculatorClient />
        </section>
      </main>
    </>
  );
