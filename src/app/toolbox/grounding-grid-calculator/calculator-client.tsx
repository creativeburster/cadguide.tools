    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"IEEE 80: R_g = rho*(ln(L/sqrt(A)) + 0.5*(1+1/(2.5+1.5*L/r))^0.5). Step voltage E_step = (rho*0.116)/sqrt(t). Touch voltage E_touch = (rho*0.157)/sqrt(t). Includes grid geometry, rod count, soil resistivity."}
        </p>
