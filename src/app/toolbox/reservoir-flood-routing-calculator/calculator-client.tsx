    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Modified Puls: 2S/dt + O = f(2S/dt - O, O). Continuity: I-O = dS/dt. Storage-elevation curve + outlet rating curve. Time step dt. Includes emergency spillway and dam break option."}
        </p>
