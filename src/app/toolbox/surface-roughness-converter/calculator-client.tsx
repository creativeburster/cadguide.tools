    ...
    <div className="space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 bg-white rounded-3xl border border-slate-100 p-8 shadow-sm space-y-6">
          ...
          <div>
            <label className="text-xs font-black text-slate-400 uppercase tracking-wider block mb-2">Parameter Type</label>
          ...
          <div>
            <label className="text-xs font-black text-slate-400 uppercase tracking-wider block mb-2">{inputType} Value (µm)</label>
            <input
              type="number"
              step="0.01"
              value={inputValue}
          ...
          <div className="rounded-2xl bg-blue-50 border border-blue-100 p-4">
            <p className="text-xs font-bold text-blue-600">ISO N-Grade</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
              ...
              {([
                ...
                >
                  ...
                  <p className={`text-2xl font-black ${item.highlight ? 'text-blue-600' : 'text-slate-900'}`}>
                    ...
                    <span className="text-xs text-slate-400 font-bold ml-1">µm</span>
                  </p>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 text-xs">
              <div className="bg-slate-50 rounded-xl p-4">
                <p className="font-black text-slate-400 uppercase tracking-wider text-[10px] mb-2">Conversion Factors</p>
              ...
              <div className="bg-slate-50 rounded-xl p-4">
                <p className="font-black text-slate-400 uppercase tracking-wider text-[10px] mb-2">ISO 1302 Symbol</p>
                <div className="flex items-center gap-3">
                  <svg viewBox="0 0 60 40" className="w-16 h-10">
                    <path d="M 5 30 L 25 30 L 35 10 L 55 10" fill="none" stroke="#1e40af" strokeWidth="2" />
                    <text x="30" y="28" className="fill-blue-600 text-[10px] font-bold">{conversions.nGrade}</text>
                  </svg>
          ...
          <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
            <h3 className="text-sm font-black text-slate-900 mb-4">Manufacturing Process Capability (Ra range)</h3>
              ...
              {PROCESS_RANGES.map(p => {
                ...
                return (
                  <div key={p.process} className="flex items-center gap-3">
                    <span className="text-xs font-bold text-slate-600 w-28 shrink-0">{p.process}</span>
            ...
            <p className="text-[10px] text-slate-400 mt-2 font-medium">Highlighted processes can achieve your target Ra of {conversions.ra.toFixed(3)} µm.</p>
          </div>
        </div>
      </div>
