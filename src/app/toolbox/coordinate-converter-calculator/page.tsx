...
import CoordinateConverterCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Coordinate System Converter",
  description: "Convert between lat/long and UTM coordinate systems.",
  path: '/toolbox/coordinate-converter-calculator',
});

export default function CoordinateConverterCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Coordinate System Converter", path: '/toolbox/coordinate-converter-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Coordinate System <span className="text-teal-400">Converter</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Convert between lat/long and UTM coordinate systems.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <CoordinateConverterCalculatorClient />
        </section>
      </main>
    </>
  );
