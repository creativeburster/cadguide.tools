    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Cohesive: Pu = 9*cu*D*(L_e-1.5D). Cohesionless: Pu = 0.5*gamma*D*L_e^2*Kp. Fixed head modifies moment. Deflection from subgrade reaction k_h. Includes p-y curve and group reduction."}
        </p>
