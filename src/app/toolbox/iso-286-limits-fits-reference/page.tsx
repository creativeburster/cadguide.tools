    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-gradient-to-r from-slate-800 to-blue-950 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="flex flex-col items-center text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-black bg-blue-500/10 text-blue-300 border border-blue-500/20 mb-5 uppercase tracking-[0.15em]">
                ISO 286-1 & ISO 286-2
              </div>
        ...
        <section className="bg-white border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-sm font-black text-slate-400 uppercase tracking-wider mb-3">Fit Categories at a Glance</h2>
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-green-50 rounded-2xl border border-green-100 p-4 text-center">
                <div className="text-2xl mb-1">↔️</div>
                <div className="font-black text-green-800 text-sm">Clearance</div>
                <div className="text-xs text-green-600 font-medium mt-1">Hole always larger than shaft</div>
              </div>
              <div className="bg-amber-50 rounded-2xl border border-amber-100 p-4 text-center">
                <div className="text-2xl mb-1">⚖️</div>
                <div className="font-black text-amber-800 text-sm">Transition</div>
                <div className="text-xs text-amber-600 font-medium mt-1">Overlap possible — precision location</div>
              </div>
              <div className="bg-red-50 rounded-2xl border border-red-100 p-4 text-center">
                <div className="text-2xl mb-1">🔒</div>
                <div className="font-black text-red-800 text-sm">Interference</div>
                <div className="text-xs text-red-600 font-medium mt-1">Shaft always larger than hole</div>
              </div>
            </div>
          </div>
        </section>
