    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xl md:text-lg text-slate-300 leading-relaxed max-w-2xl font-medium">
                ...
                Press <kbd className="bg-green-500/10 text-green-300 px-2 py-0.5 rounded font-mono text-lg">Up Arrow</kbd> in the
        ...
        <section className="bg-white border-b border-slate-100 py-8 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-4">Two Workspaces, Different Shortcuts</h2>
                ...
                <div className="space-y-2 text-lg">
                  {[
                    ...
                    <div key={item.k} className="flex items-center gap-3">
                      <kbd className="font-mono bg-slate-900 text-green-300 px-2.5 py-1 rounded-lg font-black text-base select-all min-w-[80px] text-center">{item.k}</kbd>
