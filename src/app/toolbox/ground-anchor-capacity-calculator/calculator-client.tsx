    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"T_ult = pi*D_b*L_b*tau_bond. tau 50-400 kPa by soil. Design = T_ult/FS (2.0 permanent, 1.5 temp). Free length min 3m soil, 1m rock. Includes creep and corrosion protection."}
        </p>
