...
import PunchingForceCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Punching Force Calculator",
  description: "Calculate punching and shearing force for sheet metal operations.",
  path: '/toolbox/punching-force-calculator',
});

export default function PunchingForceCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Punching Force Calculator", path: '/toolbox/punching-force-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Punching Force <span className="text-purple-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate punching and shearing force for sheet metal operations.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <PunchingForceCalculatorClient />
        </section>
      </main>
    </>
  );
