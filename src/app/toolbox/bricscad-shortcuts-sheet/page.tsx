...
import HexagonBricsCADClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'BricsCAD Hotkeys & Command Customization Guide | CADGuide.tools',
  description: 'Interactive index of BricsCAD Lite, Pro, and BIM keyboard commands and quad cursor controls. Print optimized cheatsheet.',
  path: '/toolbox/bricscad-shortcuts-sheet',
});

export default function HexagonBricsCADPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Hexagon BricsCAD Shortcuts', path: '/toolbox/bricscad-shortcuts-sheet' },
  ]);
