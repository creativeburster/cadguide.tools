    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"gamma_d_max from Proctor peak. Relative compaction = gamma_d_field/gamma_d_max*100%. Spec 95% structural, 90% landscape. Zero air voids: gamma_zav = G_s*gamma_w/(1+w*G_s). Standard vs modified Proctor."}
        </p>
