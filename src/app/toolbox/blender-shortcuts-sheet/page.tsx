    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-white border-b border-slate-100 py-8 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-4">Same Key, Different Mode</h2>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-orange-50 rounded-2xl border border-orange-100 p-5">
                <div className="flex items-center gap-2 mb-3">
                  <kbd className="font-mono bg-slate-900 text-orange-400 px-3 py-1.5 rounded-lg font-black text-lg select-all">M</kbd>
                  <span className="font-bold text-slate-700">Key M</span>
                </div>
                <div className="space-y-1.5 text-lg">
                  <div className="flex items-center gap-2">
                    <span className="text-base font-black text-orange-600 bg-orange-100 px-2 py-0.5 rounded">OBJECT</span>
                    <span className="text-slate-600 font-medium">Move to Collection</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-base font-black text-orange-600 bg-orange-100 px-2 py-0.5 rounded">EDIT</span>
              ...
              <div className="bg-orange-50 rounded-2xl border border-orange-100 p-5">
                <div className="flex items-center gap-2 mb-3">
                  <kbd className="font-mono bg-slate-900 text-orange-400 px-3 py-1.5 rounded-lg font-black text-lg select-all">I</kbd>
