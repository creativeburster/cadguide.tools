      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-white border-b-2 border-slate-200 py-14 print:hidden">
          <div className="max-w-[900px] mx-auto px-6 md:px-12 text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-base font-black bg-slate-100 text-slate-600 border border-slate-200 mb-4 uppercase tracking-[0.15em]">
              ISO 1302 · ISO 4287
            </div>
        ...
        <section className="bg-slate-50 border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-4">Ra Value Scale (μm)</h2>
            <div className="flex items-center gap-1 overflow-x-auto pb-2">
              {[
                ...
                <div key={r.val} className={`flex-shrink-0 rounded-xl px-3 py-2 text-center ${r.color} min-w-[80px]`}>
                  <div className="font-mono font-black text-lg">{r.val}</div>
                  <div className="text-sm font-bold uppercase tracking-wider">{r.label}</div>
                </div>
              ))}
            </div>
          </div>
