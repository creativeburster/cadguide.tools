    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"Peak flow from WSFU using Hunter curve. Includes diversity factor, simultaneous use, ASPE/IPC fixture unit tables. Pipe sizing from velocity (max 2.4 m/s hot, 3.0 cold)."}
        </p>
