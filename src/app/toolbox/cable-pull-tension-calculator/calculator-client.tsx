    ...
    <div className="space-y-8">
      <div className="bg-white rounded-3xl border border-slate-100 p-8 shadow-sm">
        ...
        <p className="text-base text-slate-600 leading-relaxed font-medium">
          {"T = T_prev + L*w*mu (straight). T = T_prev*exp(mu*theta) (curve). Sidewall pressure = T/R. Max tension from cable NEC tables. Includes weight correction factor, jamming ratio, and conduit fill."}
        </p>
