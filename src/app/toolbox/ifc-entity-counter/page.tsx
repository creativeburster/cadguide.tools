...
import IfcEntityCounterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "IFC Entity Counter and Validator",
  description: "Calculate IFC file entity counts and spatial hierarchy metrics.",
  path: '/toolbox/ifc-entity-counter',
});

export default function IfcEntityCounterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "IFC Entity Counter and Validator", path: '/toolbox/ifc-entity-counter' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              IFC Entity Counter and <span className="text-teal-400">Validator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate IFC file entity counts and spatial hierarchy metrics.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <IfcEntityCounterClient />
        </section>
      </main>
    </>
  );
