...
import SteelBeamLoadCalculatorClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: "Steel Beam Load Capacity Calculator",
  description: "Calculate allowable load and bending stress for steel beams.",
  path: '/toolbox/steel-beam-load-calculator',
});

export default function SteelBeamLoadCalculatorPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: "Steel Beam Load Capacity Calculator", path: '/toolbox/steel-beam-load-calculator' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-20 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Steel Beam Load Capacity <span className="text-orange-400">Calculator</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              Calculate allowable load and bending stress for steel beams.
            </p>
          </div>
        </section>
        <section className="py-16 max-w-[1200px] mx-auto px-6 md:px-12">
          <SteelBeamLoadCalculatorClient />
        </section>
      </main>
    </>
  );
