    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        ...
        <section className="bg-slate-950 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xl md:text-lg text-slate-400 leading-relaxed max-w-3xl font-medium">
        ...
        <section className="bg-white border-b border-slate-100 py-6 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <h2 className="text-lg font-black text-slate-400 uppercase tracking-wider mb-3">Rendering Mode Shortcuts</h2>
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div key={mode.key} className={`flex items-center gap-2 rounded-xl px-4 py-2.5 ${mode.color}`}>
                  <kbd className="font-mono font-black text-base select-all">{mode.key}</kbd>
