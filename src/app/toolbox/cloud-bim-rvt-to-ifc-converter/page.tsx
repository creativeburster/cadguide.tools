...
import CloudBimRvtToIfcConverterClient from './calculator-client';

export const metadata: Metadata = pageMetadata({
  title: 'Best Online Revit RVT to openBIM IFC Exporters Review | CADGuide.tools',
  description: 'Evaluate the best Revit RVT to buildingSmart IFC converters. Find compliant exporters that preserve parameters and spaces mapping.',
  path: '/toolbox/cloud-bim-rvt-to-ifc-converter',
});

export default function CloudBimRvtToIfcConverterPage() {
  const breadcrumbs = siteBreadcrumbLd([
    { name: 'Home', path: '/' },
    { name: 'Toolbox', path: '/toolbox' },
    { name: 'Online Revit RVT to openBIM IFC Standard Converter', path: '/toolbox/cloud-bim-rvt-to-ifc-converter' },
  ]);
    ...
    <>
      ...
      <main className="min-h-screen bg-slate-50 print:bg-white print:min-h-0">
        <section className="bg-slate-900 text-white py-16 relative overflow-hidden print:hidden">
          ...
          <div className="max-w-[1000px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-black mb-6 tracking-tight leading-tight">
              Online Revit RVT to openBIM IFC Standard Converter
            </h1>
        ...
        <section className="py-12 max-w-[1000px] mx-auto px-6 md:px-12 print:p-0">
          <CloudBimRvtToIfcConverterClient />
        </section>
      </main>
    </>
);
