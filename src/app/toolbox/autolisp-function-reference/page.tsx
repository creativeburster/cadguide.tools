        ...
        <section className="bg-slate-950 text-white py-16 print:hidden">
          <div className="max-w-[1200px] mx-auto px-6 md:px-12">
            <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
              ...
              <div className="hidden md:block bg-black/40 border border-white/10 rounded-2xl p-5 font-mono text-lg min-w-[280px]">
                <div className="text-base text-slate-500 mb-2">;; Example</div>
