  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-24">
      ...
      <header className="max-w-[1360px] mx-auto px-4 sm:px-6 pt-12 lg:pt-16 pb-6 text-center">
        ...
        {/* --- EIGHT SPECIALIZED DIRECTORIES GATEWAY --- */}
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3 max-w-[1360px] mx-auto mb-10 text-left">
          {/* Card 1 */}
          <Link
            href="/guides/kernel-solidworks-siemens-nx"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-violet-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-violet-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-violet-600 uppercase tracking-wider block mb-1">Geometry Kernel</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-violet-600 transition-colors">3D Kernel Pipelines →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">Lossless B-Rep solids & tolerance stitching macro rules.</p>
          </Link>
          
          {/* Card 2 */}
          <Link
            href="/guides/standards-iso-autocad"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-emerald-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-emerald-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-emerald-600 uppercase tracking-wider block mb-1">Layer Standards</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-emerald-600 transition-colors">Drafting Standards →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">Official ISO, AIA & GB/T CAD layer templates.</p>
          </Link>

          {/* Card 3 */}
          <Link
            href="/guides/shield-autocad"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-rose-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-rose-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-rose-600 uppercase tracking-wider block mb-1">EULA Compliance</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-rose-600 transition-colors">License Audit Shield →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">FLEXlm security setup & silent deploy configs.</p>
          </Link>

          {/* Card 4 */}
          <Link
            href="/guides/industry-pcb-design"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-blue-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-blue-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-blue-600 uppercase tracking-wider block mb-1">Procurement TCO</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-blue-600 transition-colors">Enterprise TCO Matrix →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">3-Yr TCO analysis & multi-platform comparisons.</p>
          </Link>

          {/* Card 5 */}
          <Link
            href="/guides/standards-aia-revit"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-teal-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-teal-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-teal-600 uppercase tracking-wider block mb-1">BIM Standards</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-teal-600 transition-colors">AIA Revit Layering →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">US National CAD Standard V6 structures for Revit.</p>
          </Link>

          {/* Card 6 */}
          <Link
            href="/guides/shield-solidworks"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-amber-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-amber-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-amber-600 uppercase tracking-wider block mb-1">EULA Security</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-amber-600 transition-colors">SW Telemetry Shield →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">Wipe local MAC pings & disable software tracking.</p>
          </Link>

          {/* Card 7 */}
          <Link
            href="/guides/kernel-rhino-3d-autocad"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-indigo-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-indigo-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-indigo-600 uppercase tracking-wider block mb-1">Kernel Sew</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-indigo-600 transition-colors">Rhino to ACIS DWG →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">Prevent edge fracturing & boundary surface splitting.</p>
          </Link>

          {/* Card 8 */}
          <Link
            href="/guides/industry-hvac-mep"
            className="group block p-3 rounded-xl bg-white border border-slate-100 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all hover:border-cyan-200 relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 w-12 h-12 bg-cyan-500/5 rounded-full blur-lg -mr-4 -mt-4 group-hover:scale-125 transition-transform"></div>
            <span className="text-[8px] font-mono font-black text-cyan-600 uppercase tracking-wider block mb-1">MEP Procurement</span>
            <h3 className="text-[10px] font-bold text-slate-800 leading-snug group-hover:text-cyan-600 transition-colors">HVAC TCO Matrix →</h3>
            <p className="text-[9px] text-slate-400 mt-1 line-clamp-2">Enterprise SaaS pricing curve & named-user audits.</p>
          </Link>
        </div>
