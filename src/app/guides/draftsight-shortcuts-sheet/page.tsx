...
export const metadata: Metadata = pageMetadata({
  ...
  path: '/guides/draftsight-shortcuts-sheet',
});
...
export default function DassaultDraftSightPage() {
  const breadcrumbs = siteBreadcrumbLd([
    ...
    { name: 'Dassault DraftSight Shortcuts', path: '/guides/draftsight-shortcuts-sheet' },
  ]);
        ...
        <section className="bg-slate-900 text-white py-16 relative overflow-hidden print:hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-black mb-6 tracking-tight leading-tight">
              Dassault DraftSight <span className="text-blue-400">Keyboard Shortcuts and Commands</span> Cheat Sheet
            </h1>
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed max-w-2xl mx-auto font-medium">
              AutoCAD Competitive cost-effective solution. Organized DraftSight 2D Drawing shortcut aliases, layer table management commands and viewport configuration. 
            </p>
          </div>
        </section>
