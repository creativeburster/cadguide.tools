...
export async function generateMetadata(
  ...
  return {
    ...
    robots: { index: false, follow: false }, // hidden section (owner decision): live at direct URL, out of search index
  };
}
              ...
              <Card className="rounded-[24px] md:rounded-[32px] p-6 sm:p-8 border border-slate-100 shadow-sm bg-white space-y-6">
                <div className="flex items-center gap-4 border-b border-slate-50 pb-5">
                  ...
                  <div>
                    ...
                    {matchedTool.score > 0 && (
                      <span className="text-amber-600 font-black text-xs">★ {matchedTool.score} / 5.0 Rating</span>
                    )}
                  </div>
                </div>
