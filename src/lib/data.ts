...
export const tools: Tool[] = [
  {
    ...
    pricing_tiers: [
      {
        ...
        price: '255',
        period: '/mo',
        features: ['2D Drafting', '3D Modeling', 'Specialized Toolsets', 'AutoLisp Support'],
        is_popular: false,
      },
      {
        name: 'Annual',
      ...
      },
      {
        ...
        price: '6,090',
        period: '/3yr',
        features: ['Locked-in pricing', 'All Pro features', 'Enterprise Support'],
        is_popular: false,
      },
    ],
    ...
    core_features: ['2D Drafting', '3D Modeling', 'AutoLisp', 'Sheet Sets', 'Cloud Storage'],
  ...
  },
  {
    ...
    pricing_tiers: [
      {
        ...
        features: ['Full 3D Design', 'Standard Library', 'Sustainability tools', 'Cloud Services'],
      ...
      },
      {
        ...
        price: '3,995',
        period: 'one-time',
        features: ['Owned license', 'Add-on required for Cloud', 'Maintenance extra'],
        is_popular: false,
      },
    ],
    ...
    core_features: ['Parametric 3D', 'Assemblies', 'Simulation', 'Sheet Metal', 'PDM Support'],
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        price: '595',
        period: 'one-time',
        features: ['Update existing license', 'Latest V8 features', 'New render engine'],
        is_popular: false,
      },
    ],
    detailed_features: [
    ...
    pricing_tiers: [
      {
        ...
        features: ['Parametric Modeling', 'Synchronous Technology', 'Basic Assemblies', 'Drafting'],
      ...
      },
      {
        ...
        price: '6,500',
        period: '/yr',
        features: ['Advanced Surfacing', 'Sheet Metal', 'Plastic Part Design', 'Routing'],
        is_popular: false,
      },
      {
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        features: ['MEP Design', 'Global Team Collaboration', 'Model Checker', 'Project Manager'],
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        price: '1,500',
        period: '/yr',
        features: ['Core Modeling', 'Team Management', 'Standard Parts', 'Mobile apps'],
        is_popular: false,
      },
    ],
    detailed_features: [
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        features: ['Full Automation', 'Custom Connections', 'CNC export', 'Complex Steel Details'],
    ...
    pricing_tiers: [
      {
        ...
        features: ['Synchronous Technology', 'Advanced Assemblies', 'Sheet Metal', 'Simulation'],
      ...
      },
      {
        ...
        features: ['Full Simulation', 'Generative Design', 'Electrical Routing', 'Additive Mfg'],
    ...
    pricing_tiers: [
      {
        ...
        price: '1,530',
        period: '/yr',
        features: ['BIM Workflow', '3D Modeling', 'Resource Manager', 'Cloud Services'],
        is_popular: true,
      },
      {
        name: 'Design Suite',
        price: '2,100',
        period: '/yr',
        features: ['Landscape design', 'Spotlight (Stage)', 'Architect features', 'Rendering'],
        is_popular: false,
      },
    ],
    detailed_features: [
    ...
    pricing_tiers: [
      {
        ...
        price: '249',
        period: '/yr',
        features: ['API Support', 'Toolbox Library', 'Batch Printing', 'Standard 2D Drafting'],
        is_popular: true,
      },
      {
        name: 'Premium',
        ...
        features: ['3D Modeling', 'Constraints', 'Full Professional features', 'Technical Support'],
  ...
  },
  {
    ...
    cons: ['Steep learning curve', 'Overwhelming UI', 'Hardware workstation req'],
    ...
    pricing_tiers: [
      {
        ...
        price: '199',
        period: '/mo',
        features: ['Residential Design', 'Auto Roofs & Stairs', '3D Library', 'Support'],
        is_popular: true,
      },
      {
        name: 'Premier Annual',
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        price: '400',
        period: '/yr',
        features: ['Full Automation', 'Visual Search', 'Batch Link', 'Advanced Scripting'],
        is_popular: false,
      },
    ],
    detailed_features: [
    ...
    cons: ['No longer free trial version', 'Subscription shift', 'Learning curve'],
    ...
    pricing_tiers: [
      {
        ...
        features: ['Full Clash Detection', '4D Scheduling', '5D Cost analysis', 'Quantification'],
    ...
    pricing_tiers: [
      {
        ...
        price: '0',
        period: '/forever',
        features: ['Full 3D Suite', 'Cycles Renderer', 'Geometry Nodes', 'Community Support'],
        is_popular: true,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        price: '0',
        period: '/forever',
        features: ['Basic Viewing', 'Limited Editing', 'Cloud Sync', 'Annotations'],
        is_popular: false,
      },
      {
        ...
        price: '4.99',
        period: '/mo',
        features: ['All 3D Formats', 'No Ads', 'Advanced Editing', 'Batch Plotting'],
        is_popular: false,
      },
      {
        name: 'Premium Annual',
        ...
        features: ['Best Value', 'Priority Support', 'Full Mobile access', 'Professional Tools'],
    ...
    pricing_tiers: [
      {
        ...
        price: '1,200',
        period: '/yr',
        features: ['Parametric Jewelry Design', 'Render Studio', 'Gems library'],
        is_popular: true,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        price: '2,500',
        period: '/yr',
        features: ['DentalCAD Core', 'Virtual Articulator', 'Provisional module'],
        is_popular: true,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        price: '50',
        period: '/mo',
        features: ['Full 3D Design', 'Auto Grading', 'Fabric Library', 'Cloud storage'],
        is_popular: true,
      },
      {
        name: 'Business',
        price: 'Custom',
        period: 'quote',
        features: ['Team collaboration', 'Asset management', 'Priority support'],
        is_popular: false,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        price: '15,000',
        period: '/yr',
        features: ['Static Structural', 'Modal Analysis', 'Heat Transfer', 'HPC support'],
        is_popular: true,
      },
    ],
  ...
  },
  {
    ...
    core_features: ['Structural Analysis', 'FEA Solver', 'Aeroelasticity', 'Optimization'],
    user_scales: ['Enterprise'],
    ...
    pricing_tiers: [
      {
        ...
        price: 'Custom',
        period: 'quote',
        features: ['Multi-physics access', 'Simulation-driven design', 'Cloud solving'],
        is_popular: true,
      },
    ],
  ...
  },
  {
    ...
    pricing_tiers: [
      ...
      },
      {
        ...
        price: '3,500',
        period: '/yr',
        features: ['Mold Design', 'Electrode design', 'Reverse Engineering', 'Full Standard'],
        is_popular: false,
      },
      {
        name: 'Premium',
        price: '4,500',
        period: '/yr',
        features: ['2-5 Axis CAM', 'Full Professional', 'Post-processing', 'Simulation'],
        is_popular: false,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        features: ['AEC BIM modeling', 'Reinforcement design', 'Visual scripting', 'Collaboration'],
  ...
  },
  {
    ...
    tech_specs: { engine: 'Visi Engine', multicore: 'N/A', gpu_optimization: 'N/A', standards: [] },
    expert_verdict: '待补充专业评语。',
  },
  {
    id: 't125',
  ...
  },
  {
    ...
    tech_specs: { engine: 'NAPA Engine', multicore: 'N/A', gpu_optimization: 'N/A', standards: [] },
    expert_verdict: '待补充专业评语。',
  },
  {
    id: 't172',
    ...
    pricing_tiers: [
      {
        ...
        features: ['Conceptual Design', 'Context Modeling', 'Traffic Simulation', 'Cloud Sharing'],
    ...
    pricing_tiers: [
      {
        ...
        features: ['High-end Rendering', 'AEC Visualization', 'Particle Flow', 'Smart Extrude'],
      ...
      },
      {
        ...
        price: '1,875',
        period: '/yr',
        features: ['Retopology tools', 'Bake to Texture', 'USD support', 'Arnold integration'],
        is_popular: true,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        price: '39',
        period: '/mo',
        features: ['Industry Standard Sculpt', 'ZRemesher', 'Dynamesh', 'PolyPaint'],
        is_popular: false,
      },
      {
        name: 'Annual',
    ...
    pricing_tiers: [
      {
        ...
        features: ['Real-time Ray Tracing', 'HDRI Editor', 'Material Graph', 'Animation module'],
    ...
    pricing_tiers: [
      {
        ...
        features: ['Core Library', 'Real-time rendering', 'Limited assets', 'Standard effects'],
      ...
      },
      {
        ...
        price: '1,499',
        period: '/yr',
        features: ['Full Object Library', 'Ray Tracing', 'Sound effects', 'Real Skies'],
        is_popular: true,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        features: ['Multi-machine use', 'Real-time Walkthrough', 'VR support', 'Asset library'],
      ...
      },
      {
        ...
        price: '538',
        period: '/yr',
        features: ['Single machine', 'Plugin-only', 'Full asset access', 'Technical support'],
        is_popular: false,
      },
    ],
    ...
    pricing_tiers: [
      {
        ...
        features: ['Full Engine Power', 'Unlimited exports', 'Revenue < $1M only', 'Learning use'],
      ...
      },
      {
        ...
        features: ['Cloud sharing', 'Unreal Engine export', 'High-res video', 'Priority support'],
