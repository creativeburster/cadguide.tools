...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Siemens NX provides integrated toolsets for design, simulation, and manufacturing, featuring Synchronous Technology.",
    country: "Germany",
    category_id: "c5",
    pricing_type: "Subscription",
    starting_price: 9000,
  ...
  },
  {
    ...
    description: "Shapr3D is a professional CAD tool built for iPad, Mac, and Windows using Parasolid.",
    country: "Hungary",
    category_id: "c2",
    pricing_type: "Subscription",
    starting_price: 299,
  ...
  },
  {
    ...
    description: "Bluebeam Revu allows users to markup, takeoff, and collaborate on PDF files for AEC.",
    country: "USA",
    category_id: "c4",
    pricing_type: "Subscription",
    starting_price: 240,
  ...
  },
  {
    ...
    description: "Solibri Office checks BIM models for integrity, quality, and coordination.",
    country: "USA",
    category_id: "c4",
    pricing_type: "Subscription",
    starting_price: 3500,
  ...
  },
  {
    ...
    description: "ARES Commander is the engine behind DraftSight and CorelCAD, running natively on Windows, Mac, and Linux.",
    country: "Germany",
    category_id: "c1",
    pricing_type: "Subscription",
    starting_price: 250,
  ...
  },
  {
    ...
    description: "QCAD is a free, open-source application for computer-aided drafting (CAD) in two dimensions (2D). It is highly modular and extensible, supporting Windows, macOS, and Linux. QCAD is praised for its simplicity and focused toolset for technical drawings.",
    country: "USA",
    category_id: "c1",
    pricing_type: "Freemium",
    starting_price: 39,
  ...
  },
  {
    ...
    description: "nanoCAD is a professional-grade CAD tool. It has a familiar interface, powerful drafting and design tools, native DWG compatibility, and an open API. It is designed to provide users with the best possible performance and modern features at a competitive price.",
    country: "Russia",
    category_id: "c1",
    pricing_type: "Subscription",
    starting_price: 200,
  ...
  },
  {
    ...
    description: "progeCAD is a 2D/3D DWG-native CAD for general-purpose drafting. The program offers very high compatibility with AutoCAD and delivers a complete set of CAD tools for drafting, design, and rendering.",
    country: "USA",
    category_id: "c1",
    pricing_type: "Perpetual",
    starting_price: 399,
  ...
  },
  {
    ...
    description: "LibreCAD is a fully comprehensive 2D CAD application that you can download and install for free. It is translated into over 30 languages and runs on Windows, macOS, and Linux.",
    country: "Community/International",
    category_id: "c1",
    pricing_type: "Free",
    starting_price: 0,
  ...
  },
  {
    ...
    description: "CADopia is a full-featured 2D and 3D drafting and design software. It is a cost-effective alternative to AutoCAD, offering professional tools and high compatibility.",
    country: "USA",
    category_id: "c1",
    pricing_type: "Perpetual",
    starting_price: 545,
  ...
  },
  {
    ...
    description: "ANSYS Mechanical is a finite element analysis (FEA) tool that enables engineers to simulate structural, thermal, and acoustic performance, helping to build better products faster.",
    country: "USA",
    category_id: "c5",
    pricing_type: "Subscription",
  ...
  },
  {
    ...
    description: "Altair HyperWorks is an open-architecture simulation platform providing best-in-class technologies to design and optimize high-performance, weight-efficient and innovative products.",
    country: "USA",
    category_id: "c5",
    pricing_type: "Subscription",
    starting_price: 12000,
  ...
  },
  {
    ...
    description: "CorelCAD delivers powerful 2D drafting and 3D design tools in a familiar CAD environment, offering DWG file compatibility at a fraction of AutoCAD's price.",
    country: "Canada",
    category_id: "c1",
    pricing_type: "Perpetual",
    starting_price: 499,
  ...
  },
  {
    ...
    description: "CAXA CAD is a professional 2D drafting and design software developed in China, offering full DWG compatibility and specialized tools for mechanical and electrical design.",
    country: "China",
    category_id: "c1",
    pricing_type: "Perpetual",
    starting_price: 800,
