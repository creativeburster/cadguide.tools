...
},
{
  ...
  detailed_features: [
    {
      category: "Drafting",
      items: [
        { name: "2D drawing tools", status: true },
        { name: "Annotation and dimensioning", status: true },
        { name: "Hatch and fill patterns", status: true },
        { name: "Block and symbol libraries", status: true },
      ],
    },
    {
      category: "Automation",
      items: [
        { name: "Programmable commands", status: true },
        { name: "Scripting and macros", status: true },
        { name: "Batch drawing generation", status: true },
        { name: "Template-based drafting", status: true },
      ],
    },
    {
      category: "Speed & Performance",
      items: [
        { name: "Extreme schematic speed", status: true },
        { name: "Large file handling", status: true },
        { name: "Optimized rendering", status: true },
        { name: "Background processing", status: false },
      ],
    },
    {
      category: "Output",
      items: [
        { name: "DWG/DXF export", status: true },
        { name: "PDF output", status: true },
        { name: "Plotter support", status: true },
        { name: "Batch printing", status: true },
      ],
    },
  ],
  country: "USA",
  ...
  starting_price: 1500,
  platforms: ["Windows"],
  industries: ["Manufacturing", "Industrial Automation", "Mechanical Engineering", "Electrical Engineering"],
  core_features: [
  ...
  license_types: ["Subscription", "Commercial"],
  ...
  key_capabilities: ["Drafting Automation", "Programmable Commands", "Extreme Speed", "Batch Processing", "DWG Compatibility"],
},
{
  id: "t53",
  name: "DWG FastView",
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        ...
        { name: "Annotation and dimensioning", status: true },
        { name: "Hatch and fill patterns", status: true },
        { name: "Multiline text (MText)", status: true },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Block and symbol libraries", status: true },
        { name: "Linetypes and weights", status: true },
        { name: "Paper space / layouts", status: true },
      ],
    },
    {
      category: "Automation",
      items: [
        { name: "ECMAScript scripting", status: true },
        { name: "Command line interface", status: true },
        { name: "Batch processing", status: false },
        { name: "Parametric constraints", status: false },
      ],
    },
    {
      category: "Compatibility",
      items: [
        { name: "DXF import/export", status: true },
        { name: "DWG import/export (Pro)", status: true },
        { name: "SVG export", status: true },
        { name: "PDF export", status: true },
      ],
    },
  ],
  country: "Germany",
  ...
  starting_price: 0,
  platforms: ["Windows", "macOS", "Linux"],
  industries: ["Architecture", "Mechanical Engineering", "Education", "Electrical Engineering", "Interior Design"],
  core_features: [
    "Layer Management",
    "Block Support",
    "DXF/DWG Support",
  ...
  key_capabilities: ["2D Drafting", "Cross-Platform", "Open Source", "Scripting", "DXF/DWG Support"],
  external_ratings: [
    {
      source: "G2",
      score: 4.4,
...
},
{
  ...
  detailed_features: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Parametric constraints", status: true },
        { name: "Mesh modeling", status: false },
      ],
    },
    {
      category: "Automation & API",
      items: [
        { name: "C++ API", status: true },
        { name: ".NET API", status: true },
        { name: "JavaScript scripting", status: true },
        { name: "Lisp support", status: true },
      ],
    },
    {
      category: "Compatibility",
      items: [
        { name: "DWG import/export", status: true },
        { name: "DXF import/export", status: true },
        { name: "IFC support (Plus)", status: true },
        { name: "PDF export", status: true },
      ],
    },
  ],
  ...
  starting_price: 0,
  platforms: ["Windows"],
  industries: ["Mechanical Engineering", "Construction", "Manufacturing", "Civil Engineering", "Architecture"],
  core_features: [
    "Native DWG Support",
    "Parametric 3D",
    "Excel Integration",
  ...
  key_capabilities: ["DWG Interoperability", "2D Drafting", "3D Modeling", "Multi-Language API", "Parametric Design"],
  external_ratings: [
    {
      source: "G2",
      score: 4.5,
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        ...
        { name: "Annotation and dimensioning", status: true },
        { name: "Hatch and fill patterns", status: true },
        { name: "Layer and block management", status: true },
      ],
    },
    {
      category: "3D Modeling",
      items: [
        ...
        { name: "Surface modeling", status: true },
        { name: "EasyArch 3D architectural plugin", status: true },
    ...
    },
    {
      category: "Utilities",
      items: [
        { name: "PDF-to-DWG conversion", status: true },
        { name: "iCADLib block manager", status: true },
        { name: "Raster image processing", status: true },
        { name: "Point cloud import", status: false },
      ],
    },
    {
      category: "Compatibility",
      items: [
        ...
        { name: "DXF import/export", status: true },
        { name: "PDF export", status: true },
        { name: "AutoCAD menu/script support", status: true },
      ],
    },
  ],
  country: "Italy",
  ...
  starting_price: 399,
  platforms: ["Windows"],
  industries: ["Architecture", "Civil Engineering", "Mechanical Engineering", "Construction", "Interior Design"],
  core_features: [
  ...
  key_capabilities: ["DWG Interoperability", "PDF-to-DWG", "2D Drafting", "3D Modeling", "Block Libraries"],
  external_ratings: [
    {
      source: "G2",
      score: 4.1,
...
},
{
  ...
  detailed_features: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Coordinate input", status: true },
        { name: "Parametric constraints", status: false },
      ],
    },
    {
      category: "Compatibility",
      items: [
        { name: "DXF import/export (native)", status: true },
        { name: "JWW import/export", status: true },
        { name: "SVG export", status: true },
        { name: "DWG import/export", status: false },
        { name: "PDF export", status: true },
      ],
    },
  ],
  ...
  starting_price: 0,
  platforms: ["Windows", "macOS", "Linux"],
  industries: ["Education", "Mechanical Engineering", "Electrical Engineering", "Architecture", "Hobbyist", "Laser Cutting"],
  core_features: [
    "Advanced Layering",
    "Block System",
    "DXF Native Support",
  ...
  tech_specs: {
    ...
    multicore: "Single-threaded",
    gpu_optimization: "None",
    standards: ["DXF", "JWW", "SVG"],
  },
  expert_verdict:
    "LibreCAD is the go-to choice for users who need a completely free, open-source 2D CAD solution without any licensing constraints. Its cross-platform support, lightweight footprint, and familiar AutoCAD-like command line make it accessible to beginners and students. However, its lack of DWG support and 3D capabilities limits its utility for professional workflows that require interoperability with AutoCAD users or 3D modeling. For pure 2D drafting in education, hobbyist projects, or small businesses with tight budgets, LibreCAD delivers exceptional value. For commercial projects requiring DWG compatibility or advanced features, paid alternatives like QCAD Pro, BricsCAD, or nanoCAD are more suitable.",
  version: "2.2.0",
  last_updated: "2025-05-20",
  free_trial_days: 0,
  languages: ["English", "German", "French", "Spanish", "Italian", "Portuguese", "Russian", "Chinese", "Japanese", "Korean", "Arabic", "Dutch", "Polish", "Turkish", "Czech", "Hungarian", "Romanian", "Swedish", "Danish", "Norwegian", "Finnish", "Greek", "Hebrew", "Hindi", "Indonesian", "Malay", "Thai", "Vietnamese", "Ukrainian", "Bulgarian"],
  file_formats_in: ["DXF", "JWW"],
  file_formats_out: ["DXF", "JWW", "SVG", "PDF"],
  integrations: [],
  deployment_options: ["Desktop"],
  license_types: ["Free", "Open-Source"],
  ...
  key_capabilities: ["Free 2D Drafting", "DXF Native Support", "Cross-Platform", "Command-Line Input", "Lightweight"],
  external_ratings: [
    {
      source: "Software Advice",
      score: 4.5,
...
},
{
  ...
  detailed_features: [
    ...
    },
    {
      category: "Automation",
      items: [
        { name: "LISP scripting", status: true },
        { name: "DCL dialog support", status: true },
        { name: "Custom commands", status: true },
        { name: "Batch processing", status: false },
      ],
    },
    {
      ...
      items: [
        { name: "DWG import/export", status: true },
        { name: "DXF import/export", status: true },
        { name: "DWT template support", status: true },
        { name: "PDF export", status: true },
      ],
    },
  ],
  ...
  starting_price: 545,
  platforms: ["Windows"],
  industries: ["Mechanical Engineering", "Architecture", "Civil Engineering", "Interior Design", "Construction"],
  core_features: [
    "Native DWG Support",
    "3D Solid Modeling",
    "LISP Support",
  ...
  expert_verdict:
    "CADopia is a solid, stable choice for firms that want a 'set it and forget it' 2D/3D CAD solution with perpetual licensing. Built on the reliable ARES engine, it offers good DWG compatibility and a familiar AutoCAD-like workflow. Its LISP support and digital signatures add value for professional users. However, its slower update cycle, Windows-only limitation, and dated marketing presence may give pause to teams seeking a more modern, actively promoted product. For small to mid-sized engineering and design firms that prioritize stability and one-time payment over the latest features, CADopia remains a viable option.",
  version: "21",
  last_updated: "2025-05-20",
  free_trial_days: 30,
  languages: ["English", "German", "French", "Spanish", "Italian", "Portuguese", "Russian", "Chinese", "Japanese"],
  file_formats_in: ["DWG", "DXF", "DWT"],
  file_formats_out: ["DWG", "DXF", "PDF", "SVG"],
  integrations: [],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Educational", "Network"],
  ...
  key_capabilities: ["DWG Interoperability", "2D Drafting", "3D Modeling", "LISP Scripting", "Perpetual Licensing"],
},
{
  id: "t62",
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        { name: "2D drawing tools", status: true },
        { name: "Annotation and dimensioning", status: true },
        { name: "Hatch and gradient fills", status: true },
        { name: "Multiline text (MText)", status: true },
      ],
    },
    {
      ...
      items: [
        { name: "3D solid modeling", status: true },
        { name: "3D surface tools", status: true },
        { name: "3D mesh editing", status: false },
        { name: "Rendering and visualization", status: false },
      ],
    },
    {
      category: "Productivity",
      items: [
        { name: "Quick Input methods", status: true },
        { name: "Annotation scaling", status: true },
        { name: "Customizable ribbon UI", status: true },
        { name: "Lisp and DCL scripting", status: true },
      ],
    },
    {
      category: "Compatibility",
      items: [
        { name: "DWG/DXF import & export", status: true },
        { name: "CorelDRAW (CDR) support", status: true },
        { name: "STL for 3D printing", status: true },
        { name: "PDF underlay and export", status: true },
      ],
    },
  ],
  country: "Canada",
  ...
  starting_price: 499,
  platforms: ["Windows", "macOS"],
  industries: ["Architecture", "Mechanical Engineering", "Construction", "Manufacturing", "Interior Design"],
  core_features: [
    "DWG Compatibility",
  ...
  key_capabilities: ["DWG Interoperability", "2D Drafting", "3D Solid Modeling", "Cross-Platform", "Perpetual Licensing"],
  external_ratings: [
    {
      source: "Software Advice",
      score: 4.5,
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        ...
        { name: "Annotation and dimensioning", status: true },
        { name: "Hatch and fill patterns", status: true },
        { name: "Text and table editing", status: true },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "BOM generation", status: true },
        { name: "Parametric constraints", status: true },
        { name: "Assembly drafting", status: false },
      ],
    },
    {
      category: "Electrical Design",
      items: [
        { name: "Electrical schematic tools", status: true },
        { name: "Symbol libraries (IEC/GB)", status: true },
        { name: "Wire numbering", status: true },
        { name: "PLC module integration", status: false },
      ],
    },
    {
      category: "Output",
  ...
  starting_price: 800,
  platforms: ["Windows"],
  industries: ["Mechanical Engineering", "Manufacturing", "Electrical Engineering", "Construction", "Automotive"],
  core_features: [
    "DWG Compatibility",
    "Parametric Drawing",
    "BOM Generation",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "The closest alternatives within the 2D CAD space are ZWCAD, GstarCAD, and浩辰CAD (GstarCAD) for Chinese-speaking users. For global users, BricsCAD, AutoCAD, and DraftSight offer similar DWG-compatible functionality. Compare them side-by-side using the CADGuide comparison tool.",
    },
  ],
  tech_specs: {
  ...
  key_capabilities: ["DWG Interoperability", "2D Drafting", "Mechanical Design", "Electrical Schematics", "BOM Generation"],
},
{
  id: "t91",
  name: "ARES Commander",
...
},
{
  ...
  short_desc:
    "Dassault Systèmes' cloud-based collaborative platform that unifies design, engineering, simulation, and manufacturing through virtual twin technology.",
  description:
    "3DEXPERIENCE is Dassault Systèmes' comprehensive cloud-based platform that integrates 3D design, engineering, simulation, and manufacturing capabilities. Built on virtual twin technology, it enables real-time collaboration across teams, disciplines, and geographies. The platform connects people, data, and processes in a single environment, supporting everything from concept design to production. With native CATIA and SOLIDWORKS integration, it serves industries from aerospace and automotive to consumer goods and life sciences.",
  pricing_tiers: [
    {
      name: "Standard",
      price: "Contact Sales",
  ...
  detailed_features: [
    {
      ...
      items: [
        ...
        { name: "Surface design", status: true },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Fluid dynamics", status: true },
        { name: "Thermal analysis", status: true },
        { name: "Motion simulation", status: true },
      ],
    },
    {
      category: "Collaboration",
      items: [
        { name: "Real-time co-editing", status: true },
        { name: "Digital mockup review", status: true },
        { name: "Project management", status: true },
        { name: "Secure cloud storage", status: true },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Additive manufacturing", status: true },
        { name: "Quality inspection", status: true },
        { name: "Production planning", status: true },
      ],
    },
  ],
  ...
  industries: ["Aerospace", "Automotive", "Industrial Equipment", "Consumer Goods", "Life Sciences", "Architecture", "Construction"],
  core_features: ["3D Design", "Virtual Twin", "Simulation & Analysis", "PLM", "Real-time Collaboration", "Manufacturing Planning"],
  user_scales: ["Mid-Sized Company", "Enterprise"],
  ...
  tech_specs: {
    ...
    standards: ["STEP", "IGES", "DWG", "JT", "3DXML"],
  },
  ...
  file_formats_in: ["STEP", "IGES", "DWG", "DXF", "JT", "3DXML", "STL", "OBJ", "SolidWorks", "Inventor"],
  file_formats_out: ["STEP", "IGES", "DWG", "DXF", "PDF", "JT", "3DXML", "STL"],
  integrations: ["CATIA", "SOLIDWORKS", "DELMIA", "SIMULIA", "ENOVIA", "SAP", "Microsoft 365", "Salesforce"],
  deployment_options: ["Cloud", "On-Premise", "Hybrid"],
  license_types: ["Subscription", "Educational", "Commercial"],
  support_channels: ["Email", "Phone", "Chat", "Community", "Documentation", "Training", "Knowledge Base", "Reseller Network"],
  security_compliance: ["ISO 27001", "SOC 2", "GDPR", "FedRAMP (selected deployments)"],
  api_sdk: {
    has_api: true,
    has_sdk: true,
    api_type: "REST / SOAP",
    sdk_languages: ["C++", "C#", "Python", "JavaScript"],
  ...
  key_capabilities: ["Cloud-Native Design", "Virtual Twin Technology", "Real-Time Collaboration", "End-to-End PLM", "Advanced Simulation", "Manufacturing Planning"],
  external_ratings: [
    {
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        { name: "2D drawing tools", status: true },
        { name: "Line, arc, circle, polyline", status: true },
        { name: "Hatch and fill patterns", status: true },
        { name: "Text and annotation", status: true },
      ],
    },
    {
      category: "Editing",
      items: [
        { name: "Trim, extend, offset", status: true },
        { name: "Mirror, array, copy", status: true },
        { name: "Layer management", status: true },
        { name: "Block and group editing", status: true },
      ],
    },
    {
      category: "Dimensioning",
      items: [
        { name: "Linear and angular dims", status: true },
        { name: "Leader and tolerance", status: true },
        { name: "Dimension styles", status: true },
        { name: "Automatic dimensioning", status: false },
      ],
    },
    {
      category: "Output",
  ...
  alternatives: ["ijcad", "rootpro-cad", "medusa4"],
  country: "Japan",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 800,
  platforms: ["Windows"],
  industries: ["Mechanical Engineering", "Architecture", "Construction", "Manufacturing"],
  core_features: ["2D Drafting", "DWG Compatibility", "JIS Standards", "Layer Management", "Dimensioning"],
  user_scales: ["Freelance", "Small Business", "Mid-Sized Company"],
  ...
  integrations: [],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Commercial"],
  support_channels: ["Email", "Phone", "Documentation"],
  security_compliance: [],
  api_sdk: {
    has_api: false,
  ...
  key_capabilities: ["2D Drafting", "DWG Interoperability", "JIS Compliance", "Layer Management", "Plotting & Output"],
},
{
  id: "t117",
  name: "KOMPAS-3D",
...
},
{
  ...
  detailed_features: [
    {
      ...
      items: [
        { name: "Water supply and drainage (ВК)", status: true },
        { name: "General site planning (ГП)", status: true },
        { name: "Electrical systems (ЭС)", status: true },
        { name: "Cable routing", status: true },
        { name: "Power transmission lines", status: true },
        { name: "HVAC (ОВ)", status: true },
        { name: "Piping systems", status: true },
        { name: "Structural design (АР, КЖ, КМ)", status: true },
      ],
    },
    {
      category: "BIM Capabilities",
      items: [
        { name: "3D information modeling", status: true },
        { name: "Parametric design", status: true },
        { name: "Automatic documentation generation", status: true },
        { name: "Model-based coordination", status: true },
      ],
    },
    {
      category: "Integration",
      items: [
        { name: "AutoCAD integration", status: true },
        { name: "nanoCAD integration", status: true },
        { name: "CADLib library manager", status: true },
        { name: "Database-driven components", status: true },
      ],
    },
    {
      category: "Specialized Tools",
      items: [
        { name: "Lightning protection design", status: true },
        { name: "Fire alarm and security", status: true },
        { name: "Panel layout designer", status: true },
        { name: "Substation design", status: true },
      ],
    },
  ],
  alternatives: ["3dexperience", "medusa4", "pconplanner"],
  ...
  starting_price: 0,
  platforms: ["Windows"],
  industries: ["Construction", "Industrial Engineering", "Civil Engineering", "Architecture", "MEP Engineering", "Power Engineering", "Infrastructure"],
  core_features: [
  ...
  key_capabilities: ["BIM Modeling", "MEP Design", "Electrical Design", "Structural Design", "AutoCAD Integration"],
},
{
  id: "t121",
...
},
{
  ...
  detailed_features: [
    ...
    },
    {
      ...
      items: [
        { name: "Bridge engineering analysis", status: true },
        { name: "Civil engineering analysis", status: true },
        { name: "Structural engineering", status: true },
        { name: "Composites analysis", status: true },
        { name: "Storage tank analysis", status: true },
    ...
    },
    {
      ...
      items: [
        { name: "3D finite element modeling", status: true },
        { name: "CAD import (DWG, DXF)", status: true },
        { name: "BIM integration", status: true },
        { name: "Mesh generation", status: true },
        { name: "Post-processing visualization", status: true },
      ],
    },
    {
      category: "Advanced Features",
      items: [
        { name: "Geotechnical analysis", status: true },
        { name: "Cable and tendon analysis", status: true },
        { name: "Construction stage analysis", status: true },
        { name: "External plugin support", status: true },
      ],
    },
  ],
  alternatives: ["midas-civil", "ansys", "abaqus"],
  country: "UK",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 0,
  platforms: ["Windows"],
  industries: ["Civil Engineering", "Bridge Engineering", "Structural Engineering", "Mechanical Engineering", "Aerospace", "Automotive", "Academic/Research"],
  core_features: [
  ...
  user_scales: ["Mid-Sized Company", "Enterprise", "Academic/Research"],
  ...
  file_formats_in: ["DWG", "DXF"],
  file_formats_out: ["DWG", "DXF", "PDF"],
  integrations: ["BIM Platforms", "CAD Systems"],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Educational", "Commercial"],
  support_channels: ["Email", "Phone", "Documentation", "Training"],
  security_compliance: [],
  ...
  key_capabilities: ["FEA Analysis", "Bridge Engineering", "Structural Analysis", "Nonlinear Analysis", "Seismic Analysis"],
},
{
  id: "t126",
  name: "midas Civil",
...
},
{
  ...
  detailed_features: [
    {
      category: "Modeling",
      items: [
        { name: "Full hybrid modeling", status: true },
        { name: "Solid modeling", status: true },
        { name: "Surface modeling", status: true },
        { name: "Mesh modeling", status: true },
        { name: "Global Shape Modeling (GSM)", status: true },
        { name: "Parametric design", status: true },
      ],
    },
    {
      category: "Integration",
      items: [
        { name: "2D/3D transparency", status: true },
        { name: "Drawing generation", status: true },
        { name: "Assembly management", status: true },
        { name: "CAD interoperability", status: true },
      ],
    },
    {
      category: "Specialized Tools",
      items: [
        { name: "Compensator (FEA integration)", status: true },
        { name: "Tooling design", status: true },
        { name: "Industrial design tools", status: true },
        { name: "Reverse engineering", status: true },
      ],
    },
    {
      category: "Workflow",
      items: [
        { name: "Large assembly handling", status: true },
        { name: "Design automation", status: true },
        { name: "Configuration management", status: true },
        { name: "Collaboration tools", status: true },
      ],
    },
  ],
  alternatives: ["solidworks", "inventor", "solid-edge"],
  country: "Italy",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 0,
  platforms: ["Windows"],
  industries: ["Industrial Design", "Product Design", "Mechanical Engineering", "Automotive", "Consumer Products", "Manufacturing"],
  core_features: [
    "Hybrid Modeling",
    "Global Shape Modeling (GSM)",
    "2D/3D Integration",
  ...
  integrations: ["CAD Systems", "PLM Systems"],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Educational", "Commercial"],
  support_channels: ["Email", "Phone", "Documentation", "Training"],
  security_compliance: [],
  ...
  key_capabilities: ["Hybrid Modeling", "Global Shape Modeling", "2D/3D Integration", "Surface Modeling", "Assembly Management"],
},
{
  id: "t133",
  name: "Maptek Vulcan",
...
},
{
  ...
  detailed_features: [
    ...
    },
    {
      category: "Compatibility",
      items: [
        { name: "DWG read/write", status: true },
        { name: "DXF import/export", status: true },
        { name: "PDF export", status: true },
        { name: "AutoCAD command compatibility", status: true },
      ],
    },
    {
      category: "Specialized Add-ons",
      items: [
        { name: "CNC profile cutting", status: true },
        { name: "True shape nesting", status: true },
        { name: "CNC post processors", status: true },
        { name: "Batch converter", status: true },
        { name: "Dials and scales", status: true },
        { name: "Railroad sections", status: true },
      ],
    },
    {
      category: "Licensing",
      items: [
        { name: "Key-based license", status: true },
        { name: "Network floating license", status: true },
        { name: "Live cloud license", status: true },
        { name: "Dongle-based license", status: true },
      ],
    },
  ],
  alternatives: ["autocad", "bricscad", "progecad"],
  country: "India",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 249,
  platforms: ["Windows", "macOS"],
  industries: ["Architecture", "Interior Design", "Structural Engineering", "Construction", "Manufacturing", "Surveying", "Mapping", "Engineering"],
  core_features: [
    "DWG Compatibility",
    "IntelliCAD Engine",
    "2D/3D Drafting",
  ...
  user_scales: ["Small Business", "Mid-Sized Company", "Educational"],
  ...
  file_formats_in: ["DWG", "DXF"],
  file_formats_out: ["DWG", "DXF", "PDF"],
  integrations: ["CAD Systems", "CNC Machines"],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Educational", "Commercial"],
  support_channels: ["Email", "Phone", "Documentation", "Training"],
  security_compliance: [],
  ...
  key_capabilities: ["DWG Compatibility", "2D/3D Drafting", "CNC Integration", "Surveying Tools", "Perpetual Licensing"],
},
{
  id: "t144",
  name: "CADVision",
  ...
  detailed_features: [
    {
      ...
      items: [
        { name: "CAD software development", status: true },
        { name: "Geometric modeling", status: true },
        { name: "Product customization", status: true },
        { name: "Integration services", status: true },
      ],
    },
    {
      category: "Industries Served",
      items: [
        { name: "Medical devices", status: true },
    ...
    },
    {
      ...
      items: [
        { name: "Software product engineering", status: true },
        { name: "Mathematical algorithms", status: true },
        { name: "Automation solutions", status: true },
        { name: "Testing and validation", status: true },
      ],
    },
    {
      category: "Services",
      items: [
        { name: "Outsourced product development", status: true },
        { name: "CAD software integration", status: true },
        { name: "Technical documentation", status: true },
        { name: "Consulting", status: true },
      ],
    },
  ],
  alternatives: ["autodesk", "ptc", "siemens"],
  country: "India",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 0,
  platforms: ["Windows"],
  industries: ["CAD Software Development", "Product Design", "Medical Devices", "Automotive", "Transportation", "Mechanical Engineering"],
  core_features: [
  ...
  integrations: ["Custom"],
  deployment_options: ["Desktop"],
  license_types: ["Perpetual", "Commercial", "Educational"],
  support_channels: ["Email", "Phone", "Documentation"],
  security_compliance: [],
  api_sdk: {
    has_api: true,
  ...
  key_capabilities: ["CAD Software Development", "Geometric Modeling", "Product Customization", "Integration Services", "Mathematical Algorithms"],
},
{
  id: "t145",
  name: "Eberick",
