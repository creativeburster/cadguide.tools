...
},
{
  ...
  logo_url: "",
  short_desc: "Russian 3D CAD/BIM solution for construction and engineering with GOST compliance",
  description: "Model Studio CS is a Russian-developed 3D CAD and BIM system by CSoft Development, designed for construction, mechanical engineering, power, and oil & gas industries. It provides precise 3D modeling, automatic 2D drawing generation, and comprehensive project documentation with full compliance to Russian GOST and SPDS standards. The system features high automation, reusable standard component libraries, and integration with other CSoft products like RasterDesk and Topomatic Robur, enabling a complete design workflow.",
  pricing_tiers: [
    {
      name: "Perpetual License",
      price: "218600",
      period: "one-time",
      features: ["Full 3D modeling", "GOST/SPDS compliance", "Standard component libraries", "Project documentation"],
      is_popular: true,
    },
    {
      name: "Temporary License (1 year)",
      price: "131000",
      period: "/year",
      features: ["Full 3D modeling", "GOST/SPDS compliance", "Standard component libraries", "Updates included"],
      is_popular: false,
    },
  ],
  detailed_features: [
    {
      category: "3D Modeling",
      items: [
        { name: "Precise 3D modeling", status: true },
        { name: "Parametric design", status: true },
        { name: "Assembly modeling", status: true },
      ],
    },
    {
      ...
      items: [
        { name: "Automatic 2D drawing generation", status: true },
        { name: "GOST & SPDS compliance", status: true },
        { name: "Bill of materials generation", status: true },
      ],
    },
    {
      category: "Automation",
      items: [
        { name: "Design automation tools", status: true },
        { name: "Reusable component libraries", status: true },
        { name: "Report and calculation automation", status: true },
      ],
    },
    {
      category: "Integration",
      items: [
        { name: "RasterDesk integration", status: true },
        { name: "Topomatic Robur integration", status: true },
        { name: "PLM system integration", status: true },
      ],
    },
  ],
  alternatives: ["3dexperience", "medusa4", "pconplanner", "nanoCAD"],
  country: "Russia",
  category_id: "c1",
  pricing_type: "Perpetual",
  starting_price: 218600,
  platforms: ["Windows"],
  industries: ["Construction", "Mechanical Engineering", "Power", "Oil & Gas"],
  core_features: ["3D CAD", "BIM", "GOST Compliance", "Design Automation"],
  user_scales: ["Small Business", "Mid-Market", "Enterprise"],
  official_url: "https://modelstudiocs.ru/",
  affiliate_url: null,
  score: 4.2,
  pros: ["Full GOST & SPDS compliance", "High level of design automation", "Reusable standard component libraries", "Integrated CSoft ecosystem"],
  cons: ["Primarily Russian-focused interface", "Limited English documentation", "Higher initial cost"],
  faqs: [
    {
      q: "What is Model Studio CS used for?",
      a: "Model Studio CS is a Russian 3D CAD and BIM system used for construction, mechanical engineering, power, and oil & gas projects. It creates 3D models, generates 2D drawings, and produces project documentation with GOST compliance.",
    },
    {
      q: "How much does Model Studio CS cost?",
      a: "Model Studio CS perpetual license starts at 218,600 ₽. Temporary one-year licenses are available at 131,000 ₽, with discounts for small businesses.",
    },
    {
      q: "Is there a free version of Model Studio CS?",
      a: "Model Studio CS is commercial software, but a free demo version is available for testing before purchase. Educational licenses may be available for verified institutions.",
    },
    {
      q: "What operating systems does Model Studio CS support?",
      a: "Model Studio CS runs on Windows and requires nanoCAD 22-25 as its CAD platform with PostgreSQL or SQL Server (optional) for database support.",
    },
    {
      q: "Which file formats does Model Studio CS support?",
      a: "Model Studio CS supports DWG, DXF, and other standard CAD formats for compatibility with other design tools.",
    },
    {
      q: "What are the best alternatives to Model Studio CS?",
      a: "Common alternatives include 3DEXPERIENCE, nanoCAD, MEDUSA4, and pCon.planner. The best choice depends on your industry, regional standards, and budget requirements.",
    },
  ],
  tech_specs: {
    engine: "nanoCAD Platform",
    multicore: "Supported",
    gpu_optimization: "Basic",
    standards: ["GOST", "SPDS"],
  },
  expert_verdict: "Model Studio CS is an excellent choice for Russian and CIS-region companies needing full GOST and SPDS compliance with strong design automation capabilities.",
  external_ratings: [
    { source: "G2", score: 4.2, max: 5, count: 12, url: "https://www.g2.com" },
    { source: "Capterra", score: 4.0, max: 5, count: 8, url: "https://www.capterra.com" },
  ],
},
{
  id: "t121",
