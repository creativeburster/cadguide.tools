...
This expert technical directive provides the official implementation blueprint for **Generative Shape Design (GSD) Surface Gaps: Healing Topology Defects**. 
...
- **Target CAD Engine**: Catia (Standards)
...
- **Official Knowledge Base Reference**: [Catia Support Page / Community Forum Link](https://www.3ds.com/products-services/catia/disciplines/mechanical-design/generative-shape-design)
